...
{ 
	...
	if (St_GpsData.u8Done == 1)
	{
		...
		if (St_GpsData.u32Longitude >= 1030000000  &&  St_GpsData.u32Longitude <= 1040000000 &&  St_GpsData.u32Latitude>= 200000000 &&  St_GpsData.u32Latitude<= 210000000)
		{
...
uint8 fuga (sint64 x0, sint64 y0, sint64 x1, sint64 y1, sint64 x2, sint64 y2, sint64 x3, sint64 y3, sint64 xp, sint64 yp){
	...
	if(yp>((m1*xp)/1000+b1) && yp>((m2*xp)/1000+b2) && yp<((m3*xp)/1000+b3) && yp<((m4*xp)/1000+b4)){ //entra if -->dentro
	f=0;
	}
	else{
		f=0xF1;
